		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navi">
				...
				<ul class="nav navbar-nav navbar-right">
					<li> <a href="/CodeNexus/index.php">Home</a></li>
					<li> <a href="/CodeNexus/index.php#myservice_section">Our Service</a></li>
					<li> <a href="/CodeNexus/logout.php">LogOut</a></li>
					<li> <a href="/CodeNexus/profile.php" id="our-location" class="btn-success" ><?php echo $_SESSION['username']; ?></a></li>
				</ul>
