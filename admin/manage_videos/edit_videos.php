          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="form-group">
                Enter SubTopic name :<input type="text" name="vid_title" class="form-control">
              ...
              <div class="modal-footer">
                <button type="submit" class="btn btn-danger" name="btn_add_new_vid" value="submit">Add</button>
        <!-- data-dismiss="modal" -->
              </div>
            </form>
            </div>
